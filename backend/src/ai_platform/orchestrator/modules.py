...
_MODULES: list[ModuleInfo] = [
    ...
    ModuleInfo(
        ...
        actions=(
            ...
            ModuleAction("chart_analyze", "Análisis profundo de gráficos con LLM visión"),
            ModuleAction("image_describe", "Describe una imagen con detalle usando visión artificial"),
            ModuleAction("document_understand", "Comprensión total de un documento/imagen con visión"),
