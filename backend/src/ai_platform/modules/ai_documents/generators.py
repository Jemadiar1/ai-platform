...
class Generators:
    ...
    def render_all(self, tenant_id: str, params: dict) -> dict:
        ...
        if docx_result.get("docx"):
            formats["docx"] = {"file": docx_result["filename"], "size_bytes": docx_result["file_size_bytes"]}
        if xlsx_result.get("xlsx"):
            formats["xlsx"] = {"file": xlsx_result["filename"], "size_bytes": xlsx_result["file_size_bytes"]}
        if pptx_result.get("pptx"):
            formats["pptx"] = {"file": pptx_result["filename"], "size_bytes": pptx_result["file_size_bytes"]}
        if pdf_result.get("pdf"):
            formats["pdf"] = {"file": pdf_result["filename"], "size_bytes": pdf_result["file_size_bytes"]}
        if png_result.get("png"):
            formats["png"] = {"file": png_result["filename"], "size_bytes": png_result["file_size_bytes"]}
        ...
        return {
            "status": "success",
            "formats": formats,
            "note": "Todos los formatos disponibles",
        }
